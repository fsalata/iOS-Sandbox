...
struct Data {
    static let recipes = [
        RecipeItem(title: "Salmon Greek Salad with Lemon Basil Dressing", description: "Light, fresh and healthy grilled salmon Greek salad. Crisp vegetables are tossed in a tangy lemon basil dressing and topped with salmon.", imageName: "meal_1", summary: [
            "difficulity" : "Medium",
            "time" : "35 min",
            "type" : "Fish",
            "ingredientCount" : "\(ingredients[0].count) ingredient"
        ], ingredients: ingredients[0], instructions: steps[0]),
        RecipeItem(title: "Fusilli Pasta with Spinach and Tomatoes", description: "Fusilli Pasta with spinach tomatoes and mushrooms! Make this quick and delicious, easy weeknight dinner! Your family will love this!", imageName: "meal_2", summary: [
            "difficulity" : "Medium",
            "time" : "25 min",
            "type" : "Vegetarian",
            "ingredientCount" : "\(ingredients[1].count) ingredient"
        ], ingredients: ingredients[1], instructions: steps[1]),
        RecipeItem(title: "Macadamia-crusted fish with green beans", description: "Macadamia-crusted fish with asparagus and green beans. Melt-in-your mouth fish with a tasty crust is perfect for a nutritious weeknight.", imageName: "meal_3", summary: [
            "difficulity" : "Easy",
            "time" : "15 min",
            "type" : "Fish",
            "ingredientCount" : "\(ingredients[2].count) ingredient"
        ], ingredients: ingredients[2], instructions: steps[2]),
        RecipeItem(title: "Grilled Salmon with Foil-Pack Sesame Broccoli", description: "Grilled salmon come together quickly with just a few simple ingredients. Making this grilled salmon makes it moist, tender.", imageName: "meal_4", summary: [
            "difficulity" : "Medium",
            "time" : "30 min",
            "type" : "Fish",
            "ingredientCount" : "\(ingredients[3].count) ingredient"
        ], ingredients: ingredients[3], instructions: steps[3])
    ]
